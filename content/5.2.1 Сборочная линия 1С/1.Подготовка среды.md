...
description: "Развертывание Linux-стенда под сборочную линию 1С: установка Docker и Portainer, утилит mono и OneScript и подготовка docker-compose с registry, samba, Jenkins и PostgreSQL."
draft: false
tags:
---
